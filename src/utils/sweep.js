            ...
            function tick() {
              ...
              batch.forEach(function (animation) {
                ...
                if (space === "RGB") {
                  ...
                  // hue
                  components[0] =
                    (Math.floor(from.h + deltas[0] * frame) + 360) % 360;
                  // saturation
                  components[1] = Math.floor(
                    (from.s + deltas[1] * frame) * 100
                  );
                  // lightness
                  components[2] = Math.floor(
                    (from.l + deltas[2] * frame) * 100
                  );
        ...
        function (require, module, exports) {
          (function () {
            ...
            hsluv.Hsluv.getBounds = function (L) {
              ...
              var sub2;
              if (sub1 > hsluv.Hsluv.epsilon) sub2 = sub1;
              else sub2 = L / hsluv.Hsluv.kappa;
              var _g = 0;
              while (_g < 3) {
                var c = _g++;
            ...
            hsluv.Hsluv.maxChromaForLH = function (L, H) {
              ...
              while (_g < bounds.length) {
                var bound = bounds[_g];
                ++_g;
                var length = hsluv.Geometry.lengthOfRayUntilIntersect(
                  hrad,
                  bound
                );
            ...
            hsluv.Hsluv.xyzToRgb = function (tuple) {
              return [
                ...
                hsluv.Hsluv.fromLinear(
                  hsluv.Hsluv.dotProduct(hsluv.Hsluv.m[1], tuple)
                ),
                hsluv.Hsluv.fromLinear(
                  hsluv.Hsluv.dotProduct(hsluv.Hsluv.m[2], tuple)
                )
              ];
            };
            ...
            hsluv.Hsluv.hexToRgb = function (hex) {
              ...
              return [
                ...
                Std.parseInt("0x" + HxOverrides.substr(hex, 3, 2)) / 255.0,
